function showPopup() {
    ...
    button.addEventListener('mouseover', function() {//เข้าไปที่ปุ่ม
        button.style.cursor = 'pointer'; // เปลี่ยนเคอเซอร์ ชี้
    });

    //ออกจากปุ่ม
    button.addEventListener('mouseout', function() {
        button.style.cursor = 'default'; //เปลีย่นเคอร์เซอร์ ปกติ
    });
    function closePopup() {
